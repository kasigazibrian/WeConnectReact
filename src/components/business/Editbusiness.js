		  ...
		  <form onSubmit={this.handleUpdateSubmit}>
			...
			<FormGroup>
			  <Col sm={"6"}>
				...
				<input name="businessName" value={this.state.businessName} onChange={this.handleChange} type="text"
					   style={{borderRadius: "20px"}} className="form-control"/>
			  </Col>
			</FormGroup>
			<FormGroup>
			  <Col sm={"6"}>
				<label>Business Location:</label>
				<Input name="businessLocation" value={this.state.businessLocation} onChange={this.handleChange}
					   type="text" style={{borderRadius: "20px"}} className="form-control"/>
			  </Col>
			</FormGroup>
			<FormGroup>
			  <Col sm={"6"}>
				<label>Business Email:</label>
				<Input name="businessEmail" value={this.state.businessEmail} onChange={this.handleChange} type="text"
					   style={{borderRadius: "20px"}} className="form-control"/>
			  </Col>
			</FormGroup>
			<FormGroup>
			  <Col sm={"6"}>
				...
				<Input value={this.state.contactNumber} onChange={this.handleChange} type="text" id="contact_number"
			...
			<FormGroup>
			  <Col sm={"6"}>
				...
				<Input name="businessDescription" onChange={this.handleChange} value={this.state.businessDescription}
					   type="textarea" id="description" style={{borderRadius: "20px"}}
			...
			<FormGroup>
			  <Col sm={"6"}>
				...
				<Input value={this.state.businessCategory} onChange={this.handleChange} type="select"
					   name="businessCategory" id="exampleSelect">
