...
class App extends React.Component {
  ...
  render() {
	...
	const Routes = () => (
	  <Router>
		<div>
		  <Route exact strict path="/register" component={BusinessRegistration}/>
		  ...
		  <Route exact strict path="/signup" component={SignupForm}/>
		  ...
		  <Route exact strict path="/edit_business/:business_id"
				 component={(props) => <EditBusiness {...props} getAuth={this.getAuth}/>}/>
		</div>
	  </Router>
	);
